...
public:
	// Default constructor
	FlyCamera(float aspect = 16.f/9.f, float fov = 45.f, float near = 1.f, float far = 100.f) : aspect(aspect), fov(fov), near(near), far(far), direction(0, 0, 1) {}
